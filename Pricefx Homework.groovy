...
My Questions:
- I have questions about the Groovy assessment test;
- Do I need to prompt the user for data, if so what data do I prompt the user for, is it the “def products” variable?
- Do I need to use the assertion example data for my assertion, if not what assertion data do I use? 
